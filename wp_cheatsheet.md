...
//Отзывы Google
              ...
              add_action('acf/render_field/name=selected_reviews', function ($field) {
                  ...
                  echo '<p style="margin: 5px 0 0; font-size: 13px;">Выберите файл с отзывами, сохраните страницу, выберите отзывы и вставьте этот шорткод в контент и опять сохраните страницу.</p>';
                  echo '</div>';
              });
